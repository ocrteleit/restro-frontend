...
export const getDashboardAnalytics = async (restaurantId = null) => {
  const url = restaurantId
    ? `${API_BASE_URL}/analytics/dashboard?filters[restaurant][id][$eq]=${restaurantId}`
...
export const getRevenueChart = async (
  ...
  if (restaurantId) url += `&filters[restaurant][id][$eq]=${restaurantId}`;
...
export const getTableOccupancy = async (restaurantId = null) => {
  const url = restaurantId
    ? `${API_BASE_URL}/analytics/table-occupancy?filters[restaurant][id][$eq]=${restaurantId}`
...
export const getKitchenOrders = async (restaurantId = null) => {
  const url = restaurantId
    ? `${API_BASE_URL}/orders/kitchen?filters[restaurant][id][$eq]=${restaurantId}`
